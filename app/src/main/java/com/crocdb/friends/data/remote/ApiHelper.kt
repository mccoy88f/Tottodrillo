...
import com.crocdb.friends.data.remote.interceptor.NoConnectivityException
 ...
 */
fun <T> NetworkResult<com.crocdb.friends.data.model.ApiResponse<T>>.extractData(): NetworkResult<T> {
    return when (this) {
